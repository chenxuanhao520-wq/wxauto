...
def debug_erp_contract_api():
    """调试 ERP 合同 API 调用"""
    print("\n" + "=" * 70)
    print("🔍 调试智邦 ERP 合同 API 调用")
    print("=" * 70)
    ...
    contract_apis = [
        ...
        "/sysa/mobilephone/systemmanage/contract.asp?datatype=tel",
        "/sysa/mobilephone/salesmanage/contract/list.asp?datatype=tel",
